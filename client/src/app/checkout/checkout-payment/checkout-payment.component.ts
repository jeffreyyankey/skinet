...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe('pk_test_51OkylhFdEiss5aHpsnCxxvhwumKcLoTzu04HeEKJRitve95PkcTi7VuGRmuvFCKOUEY75cjR8IdyapcT7lTpRIy30003AyZQRw').then(stripe => {
      this.stripe = stripe;
  ...
  private async confirmPaymentWithStripe(basket: Basket | null) {
    ...
    if (!results) throw new Error('Problem attempting payment with Stripe');
    return results;
  }
